                            ...
                            <c:forEach items="${permissions}" var="permission">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/role/findById?id=${permission.id}"
                                           class="btn bg-olive btn-xs">详情</a>
                                        <a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole?id=${permission.id}"
