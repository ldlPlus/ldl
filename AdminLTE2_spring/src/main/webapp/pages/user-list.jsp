...
<head>
    ...
    <script type="application/javascript">
        function deleteUser(id) {
            alert(id);
            $.ajax({
                url: "${pageContext.request.contextPath}/user/delete?id=" + id,
                type: "POST",
                data: {id: id},
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/user/findAll.do">用户管理</a>
                </li>
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button"
                                            ...
                                            onclick="location.href='${pageContext.request.contextPath}/user/addRole'">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                <th class="" style="padding-right: 0px"><input
                                        id="selall" type="checkbox"
                                        class="icheckbox_square-blue">
                                </th>
                                <th class="sorting_asc">ID</th>
                                <th class="sorting_desc">用户名</th>
                                <th class="sorting_asc sorting_asc_disabled">
                                    邮箱
                                </th>
                            ...
                            <c:forEach items="${users}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <c:forEach items="${user.roleNames}"
                                                   var="roleName">
                                            &nbsp;&nbsp;${roleName}
                                        </c:forEach>
                                    </td>
